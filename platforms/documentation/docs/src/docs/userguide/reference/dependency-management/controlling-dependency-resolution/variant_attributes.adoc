...
Attribute types support most Java primitive classes; such as `String`, `Boolean`, and `Integer`.
They also support any type extending `org.gradle.api.Named` and any Java `Enum` type.
